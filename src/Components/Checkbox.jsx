  ...
  return (
    <div>
      <div
        ...
        className={`flex justify-center items-center w-[100%] border-2 border-solid border-[#C8C8C8ff] p-3 rounded-xl hover:border-[#943C94ff] ${
      ...
      >
        <label className="cursor-pointer flex justify-start items-center w-[80%] gap-4">
          ...
          <div>
            <p className="font-semibold text-[#012A5Cff] md:text-[17px] text-[15px]">
              {props.service}
            </p>

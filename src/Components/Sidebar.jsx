...
export default function Sidebar(props) {
  return (
    <div className='md:bg-sidebarOne bg-no-repeat bg-cover md:w-[35%] md:h-[100%] bg-sidebarTwo w-[100%] h-[150px] md:rounded-xl'>

       <div className='flex md:w-[80%] w-[100%] h-[100%] md:flex-col flex-wrap md:justify-start justify-center md:pt-10 md:items-start items-center gap-4 md:gap-8 rounded-xl'>
